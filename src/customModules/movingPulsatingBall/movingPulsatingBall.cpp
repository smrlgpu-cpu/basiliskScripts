...
// [RL Core] Soft Saturation Function (Gradient Friendly)
...
MovingPulsatingBall::MovingPulsatingBall() {
    ...
    // [Physics] 0.5 is good for generic viscous fluid
    this->t_sr = 0.5; 
...
void MovingPulsatingBall::computeDerivatives(double integTime, Eigen::Vector3d rDDot_BN_N, Eigen::Vector3d omegaDot_BN_B, Eigen::Vector3d sigma_BN) {
    ...
    // =========================================================================
    // [PHYSICS FIX] Viscous Wall Model (No Bounce, Just Stick)
    // Liquid doesn't bounce. It dissipates energy.
    // Instead of a stiff spring, we use a "Muddy" wall.
    // =========================================================================
    ...
    // =========================================================================
    // [RL OPTIMIZATION] Soft Saturation (Tanh)
...
// UpdateState, Reset 등은 기존과 동일 (memset 유지)
